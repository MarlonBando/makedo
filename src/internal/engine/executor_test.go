...
func TestExecuteFastCommand(t *testing.T) {
	result := Execute(nil, "echo hello", nil, nil, false)
...
func TestExecuteCommandWithNonZeroExit(t *testing.T) {
	result := Execute(nil, "exit 42", nil, nil, false)
...
func TestExecuteWithOutDirective(t *testing.T) {
	...
	result := Execute(nil, "echo hello world", []*nodes.Directive{directive}, source, false)
...
func TestExecuteStallsWithNoOutput(t *testing.T) {
	...
	result := Execute(nil, "sleep 10", nil, nil, false)
...
func TestExecuteLongRunningWithDirective(t *testing.T) {
	...
	result := Execute(nil, "echo ready && sleep 10", []*nodes.Directive{directive}, source, false)
...
func TestRegistryKillAll(t *testing.T) {
	...
	result := Execute(nil, "sleep 100", nil, nil, false)
...
func runShellCmd(cmd string) error {
	return Execute(nil, cmd, nil, nil, false).Err
}
